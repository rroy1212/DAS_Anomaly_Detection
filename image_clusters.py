...
class image_clustering:
    ...
    def __init__(self, folder_path, n_clusters=5, max_examples=None, use_imagenets=False, use_pca=False):
        ...
        del paths
        try:
            shutil.rmtree("output_clusters")
        except FileExistsError:
            pass
        print("\n output folders created.")
        os.makedirs("output_clusters")
        for i in range(self.n_clusters):
            os.makedirs("output_clusters\\cluster" + str(i))
    ...
    def clustering(self):
        ...
        for i in range(self.max_examples):
            path_1 = self.folder_path+"\\"+self.image_paths[i]
            path_2 = "output_clusters\cluster"+str(predictions[i])
            print("path_1 is: ", path_1)
            print("path_2 is: ", path_2)
            shutil.copy2(path_1, path_2)
            #shutil.copy2(self.folder_path+"\\"+self.image_paths[i], "output_clusters\cluster"+str(predictions[i]))
        print("\n Clustering complete! \n\n Clusters and the respective images are stored in the \"output_clusters\" folder.")
...
if __name__ == "__main__":
   ...
   # cluster names will be 0 to number_of_clusters-1
    ...
    temp = image_clustering('anomaly_images', number_of_clusters,
